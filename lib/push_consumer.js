...
class RocketMQPushConsumer extends EventEmitter {
    ...
    constructor(groupId, instanceName, options) {
        ...
        assert(typeof options.messageModel === "string", "messageModel must be a string");
        const messageModel = MESSAGE_MODEL[options.messageModel.toUpperCase()];
        assert(messageModel !== undefined, "messageModel must be BROADCASTING or CLUSTERING");
        options.messageModel = messageModel;
